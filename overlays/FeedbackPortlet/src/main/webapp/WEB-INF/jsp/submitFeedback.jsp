...
<style>
.mdl-button--raised.mdl-button--colored, .mdl-button--raised.mdl-button--colored:hover { background: #00512b; }
</style>
...
<form:form action="${postUrl}" modelAttribute="submitFeedbackForm">
    ...
    <p class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-top: 12px; margin-bottom: 12px; width: 100% !important;">
