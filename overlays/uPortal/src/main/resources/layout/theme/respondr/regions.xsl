    ...
    <xsl:template name="region.header-left">
        <xsl:choose>
            <xsl:when test="//region[@name='header-left']/channel">
                <div id="region-header-left" class="col-sm-6 col-md-6 text-left">
            ...
            <xsl:otherwise>
                <div id="empty-region-header-left" class="col-sm-6 col-md-6 text-left"></div>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
    ...
    <xsl:template name="region.header-right">
        <xsl:choose>
            <xsl:when test="//region[@name='header-right']/channel">
                <div id="region-header-right" class="col-sm-6 col-md-6 text-right">
            ...
            <xsl:otherwise>
                <div id="empty-region-header-right" class="col-sm-6 col-md-6 text-right"></div>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
